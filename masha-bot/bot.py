...
SYSTEM_PROMPT = (
    ...
    "КОМАНДА РАЗРАБОТКИ — КОСТЯ ПРОГРАММИСТ:\n"
    "Если тебе нужно что-то запрограммировать, автоматизировать, написать скрипт "
    "или исправить что-то в коде — делегируй задачу Косте через Bash:\n"
    "  echo 'описание задачи' | bash '/Users/vladimirprihodko/Папка тест/fixcraftvp/scripts/ask-kostya.sh'\n"
    "Костя — мега-программист, работает на claude-opus-4-6, имеет полный доступ к файлам всех ботов.\n"
    "Примеры когда звать Костю:\n"
    "- нужно добавить новый режим или команду в твой бот\n"
    "- нужно написать скрипт парсинга данных для маркетингового анализа\n"
    "- есть баг который ты сама не можешь починить\n"
    "- пользователь просит изменить логику работы бота"
)
