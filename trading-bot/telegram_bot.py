...
BASE_SYSTEM_PROMPT = (
    ...
    "Если тебе нужно что-то запрограммировать, исправить баг, написать скрипт или "
    "изменить код своих файлов — делегируй задачу Косте через Bash:\n"
    ...
    "- нужно добавить новую фичу в market_scan.py\n"
    "- есть баг в коде который ты сам не можешь починить\n"
    "- нужно создать новый скрипт или утилиту\n"
    "- пользователь просит изменить логику торговли"
)
