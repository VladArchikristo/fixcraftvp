#!/usr/bin/env python3
"""
OSM Overpass Parser — пишет в основную toll_navigator.db
Таргет: 3000-8000 дорог через 12 регионов США
"""
...
# Основная БД (не backend/data — а корневая)
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
PROJECT_ROOT = os.path.join(SCRIPT_DIR, '..', '..')
DB_PATH = os.path.join(PROJECT_ROOT, 'toll_navigator.db')
OUTPUT_JSON = os.path.join(PROJECT_ROOT, 'data', 'osm_tolls_main.json')
...
log = logging.getLogger('osm-main')
...
def main():
    log.info('=== OSM Toll Road Parser → MAIN DB ===')
    ...
    # 12 регионов — разбито для избежания timeout
    regions = [
        # SW
        ...
        # NE — разбито на 4 части (плотный регион)
    ...
    print('\n' + '=' * 55)
    print('OSM PARSE → MAIN DB RESULTS')
    print('=' * 55)
