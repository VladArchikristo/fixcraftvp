...
def _call_gpt55_sync(full_prompt: str, system: str) -> tuple[bool, str]:
    """Call GPT-5.5 with retry (no two_pass, no Claude)."""
...
async def ask_gpt55(user_text: str, user_id: int, image_path: str | None = None) -> tuple[bool, str]:
    ...
    try:
        ...
        return await loop.run_in_executor(
            _claude_executor,
            lambda: _call_gpt55_sync(user_text, SYSTEM_PROMPT),
        )
    except Exception as e:
